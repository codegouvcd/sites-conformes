    ...
    return [
        ...
        grille([
            ("tile", tuile("Un site conforme au système de design",
                           ...
                           page=pages["systeme-de-design"], image=images["picto-conformite"], horizontale=True)),
            ("tile", tuile("Un site géré en autonomie",
                           ...
                           page=pages["creer-votre-site"], image=images["picto-autonomie"], horizontale=True)),
            ("tile", tuile("Un budget maîtrisé",
                           ...
                           page=pages["questions-frequentes"], image=images["picto-budget"], horizontale=True)),
            ("tile", tuile("Un site sécurisé et hébergé où vous voulez",
                           ...
                           page=pages["questions-frequentes"], image=images["picto-securite"], horizontale=True)),
        ], largeur="6"),
