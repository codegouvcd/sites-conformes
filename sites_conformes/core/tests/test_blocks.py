...
class RecentEntriesBlockTestMixin:
    ...
    def get_see_all_button(self, block):
        button = block.select_one("a.sdcd-button")
    ...
    def test_filters_visible_when_enabled(self):
        ...
        pressed_filter = block.select_one('a.sdcd-tag[aria-pressed="true"]')
    ...
    def test_filters_hidden_when_disabled(self):
        ...
        self.assertIsNone(block.select_one("a.sdcd-tag[aria-pressed]"))
